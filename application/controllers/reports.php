...
/*		For the preparation of changing the template of template_1 */
	...
	**/
	...
	function generate_los_rpt(){
        ...
        $tempFileName = ($this->losRptType == 'new') ? 'los.xlsx' : 'los_old.xlsx';
		$this->template_path =  'template/' . $tempFileName;
    ...
    function generate_new_los_rpt(){
        $this->losRptType = 'new';
        $this->generate_los_rpt();
