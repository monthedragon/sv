...
Class Main extends Auth_Controller  {
    ...
    public function index(){
        ...
        $this->set_header_data(PROJECT_NAME,'Sales Dashboard');
        ...
        $dashboardData = $this->main_model->construct_crm_dashboard($crm, $calldate);
        $data = array_merge($data, $dashboardData); // Merge returned data into $data directly
