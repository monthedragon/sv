...
class ExcelBarChart extends ExcelChartCommon
{
    /**
    ...
    public function updateChartDataTableSettings() {
        ...
        $this->dom->getElementsByTagName("catAx")->item(0)->getElementsByTagName("title")->item(0)->getElementsByTagName("t")->item(0)->nodeValue = $this->dataObject->getChartAxisTitle();
